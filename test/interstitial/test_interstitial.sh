...
# Baseline tests.
sudo build/test/interstitial/interstitial_test ipv6
...
sudo PLINEY_PIPELINE="exthdr-padn hbh 4 de => ttl 32 => target ::1 => body test/data/dns_cnn" LD_PRELOAD=build/libplineyi.so  build/test/interstitial/interstitial_test ipv6
...
sudo PLINEY_PIPELINE="exthdr-padn hbh 4 de => ttl 32 => target fd7a:115c:a1e0:ab12:4843:cd96:627b:e21e" LD_PRELOAD=build/libplineyi.so  build/test/interstitial/interstitial_test ipv6
