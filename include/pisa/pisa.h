...
bool pisa_program_add_meta_inst(pisa_program_t *pgm, const char *key, pisa_value_t value);
...
bool pisa_program_find_field_value(pisa_program_t *pgm, pisa_field_t field, pisa_value_t *value);
bool pisa_program_find_meta_value(pisa_program_t *pgm, const char *key, pisa_value_t *value);
